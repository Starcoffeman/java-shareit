...
public class UserRepositoryTest {
    ...
    public void testOneUser() {
        User user = new User();
        user.setName("John Doe56");
        user.setEmail("john56.doe@example.com");
    ...
    public void testExistsByEmail() {
        String email = "john9.doe@example.com";
    ...
    public void testMapToUsersDto(){
        User user = new User();
        user.setName("John Doe65");
        user.setEmail("john65.doe@example.com");
